...
- Zsh: ~$HOME/.zsh_completion.d~ or ~$CONFIG_DIR/zsh_completion.d~
- Bash: ~$HOME/.bash_completion.d~ or ~$CONFIG_DIR/bash_completion.d~
...
1. Check if the completion directory exists: ~ls -l ~/.zsh_completion.d~ or ~ls -l ~/.bash_completion.d~
